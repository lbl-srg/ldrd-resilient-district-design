...
equation
  ...
  connect(T1WatEnt, calTemLvg.T1Ent) annotation (Line(points={{-200,-40},{-160,
          -40},{-160,-45},{-142,-45}}, color={0,0,127}));
  ...
  connect(uCoo, mulAnd.u[3]) annotation (Line(points={{-200,160},{-170,160},{
          -170,0},{-20,0},{-20,-38},{-2,-38},{-2,-39.125}},
                          color={255,0,255}));
  ...
  connect(isValIsoEvaClo.y, mulAnd.u[4])
    annotation (Line(points={{-118,-160},{-100,-160},{-100,-20},{-24,-20},{-24,
          -42},{-2,-42},{-2,-37.375}},                                          color={255,0,255}));
