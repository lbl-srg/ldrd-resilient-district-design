...
model Chiller
  ...
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pumCon(
    redeclare final package Medium = Medium,
    final per=perPumCon,
  ...
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pumEva(
    redeclare final package Medium = Medium,
    final per=perPumEva,
    final allowFlowReversal=allowFlowReversal,
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-100,-60})));
  Controls.Chiller con(final TConWatEntMin=TConWatEntMin, final TEvaWatEntMax=
        TEvaWatEntMax) "Controller"
  ...
  LDRD.EnergyTransferStations.BaseClasses.Junction splEva(redeclare final
      package Medium = Medium, final m_flow_nominal=dat.mEva_flow_nominal .* {1,
        -1,-1}) "Flow splitter for the evaporator water circuit" annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={-140,-60})));
  LDRD.EnergyTransferStations.BaseClasses.Junction splConMix(redeclare final
      package Medium = Medium, final m_flow_nominal=dat.mCon_flow_nominal .* {1,
        -1,-1}) "Flow splitter" annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=0,
        origin={120,60})));
