...
model HeatExchanger
  ...
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pum1Hex(
    ...
    "District heat exchanger primary pump" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-60,80})));
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pum2Hex(
  ...
  LDRD.EnergyTransferStations.BaseClasses.Junction spl(redeclare final package
    ...
    "Flow splitter" annotation (Placement(transformation(
        ...
        origin={-60,-60})));
protected
  parameter Boolean have_val1Hex=conCon ==LDRD.EnergyTransferStations.Types.ConnectionConfiguration.TwoWayValve
