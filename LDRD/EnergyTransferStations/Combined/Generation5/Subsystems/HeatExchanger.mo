...
model HeatExchanger
  ...
  parameter Types.ConnectionConfiguration conCon
  ...
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pum1(
    ...
    "District heat exchanger primary pump" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-60,80})));
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pum2(
