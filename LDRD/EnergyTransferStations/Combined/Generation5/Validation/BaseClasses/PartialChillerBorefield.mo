within LDRD.EnergyTransferStations.Combined.Generation5.Validation.BaseClasses;
partial model PartialChillerBorefield
  ...
  Buildings.Fluid.Sources.Boundary_pT disWat(
    ...
    nPorts=2) "District water boundary conditions" annotation (Placement(
        ...
        rotation=0,
        origin={-110,-140})));
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pumChiWat(
    redeclare package Medium = Medium,
  ...
  LDRD.EnergyTransferStations.BaseClasses.Pump_m_flow pumHeaWat(
    redeclare package Medium = Medium,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTDisWatRet(redeclare final
      package Medium = Medium, final m_flow_nominal=ets.hex.m1_flow_nominal)
