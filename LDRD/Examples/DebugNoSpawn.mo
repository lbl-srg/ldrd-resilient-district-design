...
model DebugNoSpawn "Example of parallel connection with constant district water mass flow rate"
  extends BaseClasses.PartialParallelNoSpawn(
    redeclare
      Loads.BuildingTimeSeriesWithETS bui(final filNam=filNam),
    datDes(
      nBui=2,
      idxBuiSpa=3,
