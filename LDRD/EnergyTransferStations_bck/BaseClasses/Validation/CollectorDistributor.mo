within LDRD.EnergyTransferStations.BaseClasses.Validation;
model CollectorDistributor
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_1Sup(redeclare final package
    ...
    "Secondary supply temperature (measured)" annotation (Placement(
        ...
        rotation=0,
        origin={60,340})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT1_1Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Primary supply temperature (measured)" annotation (Placement(
        ...
        rotation=0,
        origin={-100,340})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT1_1Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Primary return temperature (measured)" annotation (Placement(
        ...
        rotation=0,
        origin={-100,300})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_1Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)" annotation (Placement(
        ...
        rotation=0,
        origin={60,300})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo1_1(redeclare final package
      Medium = Medium) "Primary mass flow rate (measured)"
    annotation (Placement(transformation(extent={{-140,330},{-120,350}})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo2_1(redeclare final package
      Medium = Medium) "Secondary mass flow rate (measured)"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_2Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary supply temperature (measured)" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={60,200})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_2Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={60,160})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo2_2(redeclare final package
      Medium = Medium) "Secondary mass flow rate (measured)"
  ...
  LDRD.EnergyTransferStations.BaseClasses.CollectorDistributor colDis(
    redeclare final package Medium = Medium,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_3Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary supply temperature (measured)" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={60,60})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT1_2Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Primary supply temperature (measured)" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-100,60})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT1_2Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Primary return temperature (measured)" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={-100,20})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_3Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={60,20})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo1_2(redeclare final package
      Medium = Medium) "Primary mass flow rate (measured)"
    annotation (Placement(transformation(extent={{-140,50},{-120,70}})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo2_3(redeclare final package
      Medium = Medium) "Secondary mass flow rate (measured)"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_4Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary supply temperature (measured)" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={60,-80})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_4Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={60,-120})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo2_4(redeclare final package
      Medium = Medium) "Secondary mass flow rate (measured)"
  ...
  LDRD.EnergyTransferStations.BaseClasses.CollectorDistributor colDis1(
    redeclare final package Medium = Medium,
    mCon_flow_nominal=fill(m_flow_nominal, 2),
    nCon=2) "Collector/distributor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_5Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary supply temperature (measured)" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={60,-220})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT1_3Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Primary supply temperature (measured)" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-100,-220})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT1_3Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Primary return temperature (measured)" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={-100,-260})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_5Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={60,-260})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo1_3(redeclare final package
      Medium = Medium) "Primary mass flow rate (measured)"
    annotation (Placement(transformation(extent={{-140,-230},{-120,-210}})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo2_5(redeclare final package
      Medium = Medium) "Secondary mass flow rate (measured)"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_6Sup(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary supply temperature (measured)" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={60,-360})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2_6Ret(redeclare final package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={60,-400})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo2_6(redeclare final package
      Medium = Medium) "Secondary mass flow rate (measured)"
  ...
  LDRD.EnergyTransferStations.BaseClasses.CollectorDistributor colDis2(
    redeclare final package Medium = Medium,
    mCon_flow_nominal=fill(m_flow_nominal, 2),
    nCon=2) "Collector/distributor"
