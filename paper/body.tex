...
\notebox{%
Compute nominal operating point of oversized coil: what is the impact on the CHW delta-T? Nominal flow rate and pressure drop?

Assess number of rows

TODO: run simulations with a nominal pressure drop increased by the sizing factor.
}
...
Assess number of rows: base case and oversized

TODO: run simulations with a nominal pressure drop and mass flow unchanged for other equipment than fan.
}
